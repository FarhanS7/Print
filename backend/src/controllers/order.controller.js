...
export const checkoutController = async (req, res) => {
    try {
        ...
        const session = await createCheckoutSession(designId, userId, design.price || product.basePrice || 24.99, design.title || product.name || "Custom Design", design.artworkUrl);
